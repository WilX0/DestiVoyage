...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
 ...
 $query_check = "SELECT * FROM favvol WHERE id_vols = ? AND user_id = ?";
...
if($result_check){
    ...
    $query = "INSERT INTO favvol (id_vols, depart, arrive, datedep, datearr, duree, prix, classe, type_vol,user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
