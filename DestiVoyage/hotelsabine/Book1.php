<?php include_once("testvols1.php");?>
<!DOCTYPE html>
<html lang="fr">
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["search"])) :
    ...
    $class = $_GET['class'];
    $departureCity = getCityName($departure);
    $destinationCity = getCityName($destination);

    $_SESSION['depart']=$departureCity;
    $_SESSION['arr']=$destinationCity;
   ...
   <?php
    echo $departureCity." + ".$destinationCity;
