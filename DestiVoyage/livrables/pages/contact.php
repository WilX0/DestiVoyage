...
/**
 * @file
 * Fichier PHP pour gérer le formulaire de contact et afficher les messages de succès ou d'erreur.
 * 
 *  * PHP version 7.3.11
 * 
 * @category Formulaire_Contact
 * @package  Projet_DWA
 * 
...
session_start();
/**
 * Affiche un message de succès ou d'erreur en fonction des paramètres GET.
 * 
 * @return void
 */
