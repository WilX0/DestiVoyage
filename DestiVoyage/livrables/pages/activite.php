...
/**
 * @file
 * Fichier PHP pour la recommandation de destination basée sur la dernière destination de l'utilisateur. 
 * PHP version 7.3.11
 * 
...
<!DOCTYPE html>
    ...
    if (isset($_SESSION["login"])) {
        // echo $_SESSION["email"];
         // Si l'utilisateur est connecté, inclure la barre de navigation pour les utilisateurs connectés
        ...
        ?>
                                    ...
                                    <ul class="custom-list">
                                        <?php   
                                        // Configuration des informations d'authentification pour Amadeus API
            ...
            /**
             * @param string $clientId Identifiant client pour l'API Amadeus
             * @param string $clientSecret Clé secrète pour l'API Amadeus
             * @param string $apiUrl URL de l'API Amadeus pour obtenir le jeton d'accès
             * @return string|null Le jeton d'accès ou null en cas d'échec
             */
                                        ...
                                        // Fonction pour rafraîchir le jeton d'accès si nécessaire
            /**
             * @param string $clientId Identifiant client pour l'API Amadeus
             * @param string $clientSecret Clé secrète pour l'API Amadeus
             * @param string $apiUrl URL de l'API Amadeus pour obtenir le jeton d'accès
             */
                                        ...
                                        function refreshTokenIfNeeded($clientId, $clientSecret, $apiUrl) {
                                         ...
                                         // Appel de la fonction pour rafraîchir le jeton d'accès si nécessaire
                                    ...
                                    /**
 * Obtient les activités disponibles dans une région spécifique en utilisant les coordonnées géographiques.
 *
 * @param float $latitude Latitude de la région
 * @param float $longitude Longitude de la région
 * @param string $accessToken Jeton d'accès OAuth2 pour l'API Amadeus
 * @return array|null Tableau associatif des données des activités ou null en cas d'échec
 */
