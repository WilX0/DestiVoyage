...
/**
 * @file
 * Fichier PHP pour gérer la connexion des utilisateurs à travers un formulaire.
 * 
 *  * PHP version 7.3.11
 * 
 * @category Connexion_Utilisateur
 * @package  Projet_DWA
 * 
...
<?php
/**
 * Affiche un message d'activation s'il existe dans la session.
 * 
 * @return void
 */
...
/**
 * Vérifie les données du formulaire de connexion et authentifie l'utilisateur.
 * 
 * @param string $_POST['mail']     L'adresse e-mail soumise dans le formulaire.
 * @param string $_POST['password'] Le mot de passe soumis dans le formulaire.
 * 
 * @return void
 */
