...
/**
 * @file
 * Contient des fonctions liées à l'interaction avec l'API Amadeus pour la recherche de vols.
 *
...
/**
 * @brief Fonction pour obtenir le jeton d'accès à l'API Amadeus.
 *
 * @param string $clientId ID du client.
 * @param string $clientSecret Secret du client.
 * @param string $apiUrl URL de l'API pour obtenir le jeton.
 * @return string|null Jeton d'accès ou null en cas d'échec.
 */
...
/**
 * @brief Rafraîchit le jeton d'accès si nécessaire.
 *
 * @param string $clientId ID du client.
 * @param string $clientSecret Secret du client.
 * @param string $apiUrl URL de l'API pour obtenir le jeton.
...
/**
 * @brief Obtient les détails des vols aller-retour à partir des paramètres GET.
 *
 * @param string $departure Aéroport de départ.
 * @param string $destination Aéroport d'arrivée.
 * @param string $date Date de départ.
 * @param int $nbradulte Nombre d'adultes.
 * @param string $class Classe de voyage.
 * @return void
 */
...
function getFlightDetails($departure,$destination,$date,$nbradulte,$class,$direction) {
    ...
    ?>
<div class="container">
<h1 class="text-center text-white">ALLER-RETOUR</h1>
...
/**
 * @brief Obtient les détails des vols aller simple à partir des paramètres GET.
 *
 * @param string $departure Aéroport de départ.
 * @param string $destination Aéroport d'arrivée.
 * @param string $date Date de départ.
...
?>
                ...
                <input type="hidden" name="vol_id" value="<?= $flightIdentifier ?>">
                        ...
                        <input class="btnselect" type="submit" value="Ajouter au favoris">
