...
if (isset($_SESSION['email'])) {
    ...
    $resultRegisteredFlights = mysqli_query($connection, $queryRegisteredFlights);

    $registeredFlights = array();
    if ($resultRegisteredFlights && mysqli_num_rows($resultRegisteredFlights) > 0) {
        while ($row = mysqli_fetch_assoc($resultRegisteredFlights)) {
            $registeredFlights[] = $row;
        }
    }
}
?>
...
<body>
    ...
    <main class="container">
        <section class="nav-sidebar">
            <div class="user-info">
            <span id="colorful"><?php echo ($user['nom'] ?? ''); ?></span>
            <span id="colorful"><?php echo ($user['nom'] ?? ''); ?></span>
            </div>
            <hr>
        ...
        <section class="main-section">
            <div class="user-description">
                <img src="images/wila.jpg" alt="User Image" class="user-photo">
                <p id="description">KJBQJHBSBSCJSVSJVBSJCSBCSJCBS JC SC SC? SC</p>
                <blockquote>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam dolores veritatis dolorum atque maxime optio voluptatibus, explicabo et velit, odio in vero ducimus quam repellat dolore suscipit quibusdam. Facere, dolorem.</p>
                </blockquote>
            </div>
            <h2 id="volsTitle">Vols Enregistrés</h2>
            <?php
        ...
        <img src="images/mustuse.jpg" alt="" id="bestimage">
    </main>
